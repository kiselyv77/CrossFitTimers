...
class MyViewModelFactory(private val countdownTime:Long = 5, private val timeEnd:Long = 2, private val intervals:Long = 10): ViewModelProvider.NewInstanceFactory() {
