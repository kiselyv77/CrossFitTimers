<p><h2>Учебный проэкт предстовляющий из себя приложение с такмерами для тренеровок.В приложении есть 4 различных таймера с множеством настроек. Приложение построенно на архетектуре MVVM.
